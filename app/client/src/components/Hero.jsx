  ...
  return (
    <section className="bg-[#fcf7f0]">
      <div className="flex flex-col md:flex-row lg:flex-row pt-16 pl-12 lg:pl-28 pr-10 pb-12 items-center justify-between ">
        <div>
          <h1 className="text-4xl md:text-4xl lg:text-6xl font-Montserrat text-center md:text-left lg:text-left">
            RUH-EIE
          </h1>
          <h1 className="text-5xl md:text-5xl lg:text-7xl font-Montserrat font-bold  text-center md:text-left lg:text-left">
            CAREER FAIR
          </h1>
          ...
          <div className="flex pb-5 justify-center  md:justify-start lg:justify-start">
            <button className="bg-black text-white text-base md:text-base lg:text-lg font-Montserrat h-10 w-36 rounded-lg">
              Find Your Job
            </button>
          </div>
        </div>
